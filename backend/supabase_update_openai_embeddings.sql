-- Switch from Gemini embeddings (768) to OpenAI embeddings (1536)
...
-- Recreate table with OpenAI embedding dimensions
CREATE TABLE journal_entries (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    user_id UUID REFERENCES auth.users(id) ON DELETE CASCADE NOT NULL,
    content TEXT NOT NULL,
    embedding VECTOR(1536),  -- OpenAI text-embedding-3-small dimensions (nullable)
