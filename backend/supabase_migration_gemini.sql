-- Migration script to update from OpenAI embeddings (1536) to Gemini embeddings (768)
...
-- Recreate table with new embedding dimensions (nullable for quota fallback)
